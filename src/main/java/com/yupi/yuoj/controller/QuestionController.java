...
public class QuestionController {
    ...
    @GetMapping("/list/all")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<List<Question>> listQuestion(){
        List<Question> questionList = questionService.list();
        return ResultUtils.success(questionList);
    }

    @GetMapping("/list/vo/all")
    public BaseResponse<List<QuestionVO>> listQuestionVO(){
...
//    private UserService userService;
    ...
    @GetMapping("/question_submit/list/all")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<List<QuestionSubmit>> listQuestionSubmit(){
    ...
    /**
     * 分页获取题目提交列表（仅管理员,用户只能看见非答案，提交代码等公开信息）
     *
